...
DEFAULT_STAGE3_PROMPT_TEMPLATE = """You are the Chairman of an LLM Council Plus council. Multiple AI models have provided responses to a user's question, and then ranked each other's responses.
